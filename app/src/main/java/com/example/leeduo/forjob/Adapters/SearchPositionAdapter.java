...
public class SearchPositionAdapter extends RecyclerView.Adapter<RecommendPositionAdapter.ViewHolder> {

    private Context context;
    private JsonRecommendHit[] jsonRecommendHits;
    private View mView;
    private RecommendPositionAdapter.OnItemTouchListener onItemTouchListener;

    public SearchPositionAdapter(Context context, JsonRecommendHit[] jsonRecommendHits){
        this.context = context;
        this.jsonRecommendHits = jsonRecommendHits;
    }

    @Override
    public RecommendPositionAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.recommend_position_item,parent,false);
        return new RecommendPositionAdapter.ViewHolder(mView);
    }

    @Override
    public void onBindViewHolder(RecommendPositionAdapter.ViewHolder holder, final int position) {
